  ...
  return (
    <>
      <div className='section-heading relative overflow-hidden pb-14 text-center'>
        <h2 className='relative z-10 mb-2 uppercase'>{headingSmall}</h2>
        ...
        <span className='pointer-events-none will-change-transform absolute left-1/2 -top-2 z-0 -translate-x-1/2 transform text-9xl font-bold uppercase text-heading opacity-5'>
          {headingLarge}
        </span>
      </div>
    </>
