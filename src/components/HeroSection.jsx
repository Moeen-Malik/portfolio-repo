...
export const HeroSection = () => {
  ...
  useEffect(() => {
    const phrases = [' Moeen Malik', ' Frontend Developer', ' Web Designer'];
    ...
    const animateText = () => {
      ...
      const interval = setInterval(() => {
        if (currentCharacterIndex <= currentPhrase.length) {
          ...
          // Move to the next phrase after 2 seconds
          setTimeout(() => {
  ...
  return (
    <>
      <div id='home' className='herosection relative overflow-hidden'>
          ...
          <div className='container relative mx-auto'>
            <div className='flex min-h-screen w-full items-center justify-center'>
              <div className='herosection-content w-full py-20 text-center md:w-3/4'>
                <div className='herosection-imagewrapper opacity-100 transform-none relative mb-5 inline-block overflow-hidden rounded-full align-middle'>
                  ...
                  <div className='herosection-image fiximage relative z-20 inline-block h-[150px] w-[150px] overflow-hidden rounded-full border-6 border-primary border-opacity-10 align-middle'>
                    <img
                      ...
                      decoding='async'
                      data-nimg='1'
                      src='/src/assets/imgs/about-me.png'
                    />
                  </div>
                </div>
                <h1 className='mb-5 text-heading opacity-100 transform-none'>
                ...
                <p className='lead mb-0 opacity-100 transform-none'>
